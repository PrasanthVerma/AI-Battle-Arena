    ...
    <div className="min-h-screen grid-bg text-on-surface flex flex-col items-center justify-center p-4 font-outfit">
      ...
      <div className="w-full max-w-md bg-surface rounded-[24px] border border-zinc-800/80 shadow-[0_12px_40px_rgba(0,0,0,0.6),0_0_30px_rgba(234,179,8,0.07)] p-8 md:p-10 relative overflow-hidden">
        ...
        <div className="text-center mb-8 flex flex-col items-center">
          ...
          <p className="text-zinc-500 text-xs font-semibold tracking-widest uppercase"> AI Battle Arena</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-2">
            ...
            <input
              ...
              placeholder="prashant@zenvy.dev"
          ...
          <button
            type="submit"
            className="w-full bg-zinc-900 border border-zinc-700/80 text-white font-bebas tracking-[0.2em] rounded-xl px-4 py-3.5 hover:bg-zinc-800 hover:border-amber-500/70 hover:shadow-[0_0_15px_rgba(234,179,8,0.15)] transition-all duration-200 active:scale-[0.98] mt-2 text-sm uppercase cursor-pointer"
          >
            Enter The Arena
          </button>
        </form>
